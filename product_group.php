...
function executeSql() {
    try {
        ...
        $sql = 'SELECT *, (Цена_продажи - Цена_закупки) AS Прибыль
                FROM Товары
                WHERE true';
        ...
        if ($stmt->rowCount() > 0) {
            echo '<table border="1">';
            echo '<tr><th>ID</th><th>Наименование</th><th>Единица измерения</th><th>Цена закупки</th><th>Цена продажи</th><th>Прибыль</th></tr>';
